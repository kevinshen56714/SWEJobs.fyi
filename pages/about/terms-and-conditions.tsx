...
import { Paragraph } from './about-data'

export default function TermsAndConditions() {
  return (
    <>
      <CustomHead title="Terms & Conditions | SWEJobs.fyi"></CustomHead>
      <Paragraph>Welcome to SWEJobs.fyi!</Paragraph>

      <Paragraph>
        These terms and conditions outline the rules and regulations for the use of
        SWEJobs.fyi&apos;s Website, located at https://www.swejobs.fyi/.
      </Paragraph>

      <Paragraph>
        By accessing this website we assume you accept these terms and conditions. Do not continue
        to use SWEJobs.fyi if you do not agree to take all of the terms and conditions stated on
        this page.
      </Paragraph>
      ...
      <Paragraph>
        We employ the use of cookies. By accessing SWEJobs.fyi, you agreed to use cookies in
        agreement with the SWEJobs.fyi&apos;s Privacy Policy.{' '}
      </Paragraph>
      ...
      <Paragraph>
        Unless otherwise stated, SWEJobs.fyi and/or its licensors own the intellectual property
        rights for all material on SWEJobs.fyi. All intellectual property rights are reserved. You
        may access this from SWEJobs.fyi for your own personal use subjected to restrictions set in
      ...
      <Paragraph>
        ...
        <ul className="list-disc pl-5">
          <li>Republish material from SWEJobs.fyi</li>
          <li>Sell, rent or sub-license material from SWEJobs.fyi</li>
          <li>Reproduce, duplicate or copy material from SWEJobs.fyi</li>
          <li>Redistribute content from SWEJobs.fyi</li>
        </ul>
      </Paragraph>

      {/* <Paragraph>
        Parts of this website offer an opportunity for users to post and exchange opinions and
        information in certain areas of the website. SWEJobs.fyi does not filter, edit, publish or
        review Comments prior to their presence on the website. Comments do not reflect the views
        and opinions of SWEJobs.fyi,its agents and/or affiliates. Comments reflect the views and
        opinions of the person who post their views and opinions. To the extent permitted by
        applicable laws, SWEJobs.fyi shall not be liable for the Comments or for any liability,
        damages or expenses caused and/or suffered as a result of any use of and/or posting of
        and/or appearance of the Comments on this website.
      </Paragraph>

      <Paragraph>
        SWEJobs.fyi reserves the right to monitor all Comments and to remove any Comments which can
      ...
      <Paragraph>
        You hereby grant SWEJobs.fyi a non-exclusive license to use, reproduce, edit and authorize
      ...
      <Paragraph>
        ...
        visibility of the hyperlink compensates the absence of SWEJobs.fyi; and (d) the link is in
      ...
      <Paragraph>
        ...
        linking to our website, you must inform us by sending an e-mail to SWEJobs.fyi. Please
      ...
      <Paragraph>
        No use of SWEJobs.fyi&apos;s logo or other artwork will be allowed for linking absent a
